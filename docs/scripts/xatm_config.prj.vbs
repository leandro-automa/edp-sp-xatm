...
Sub xatm_BTC_OnStartRunning()
	...
	AddProperty bag, "Enabled", "Boolean", True, _
		...
		"Habilita��o geral deste automatismo. Pedidos de partida s�o recusados e a sequ�ncia em andamento para enquanto estiver False."
	...
	AddProperty bag, "Running", "Boolean", False, _
		...
		"True enquanto uma sequ�ncia est� em andamento. Lido pelos demais automatismos para exclus�o m�tua, de modo que apenas um execute por vez."

	AddProperty bag, "Transformer", "xatm_Transformer", Empty, _
		"Transformer XObject this automation instance is bound to.", _
		"XObject do transformador ao qual esta inst�ncia do automatismo est� vinculada."
	...
	AddProperty bag, "Preconditions", "Boolean", True, _
		...
		"Condi��es de campo que devem valer antes de uma sequ�ncia partir. Vinculada a uma express�o - True enquanto a manobra � permitida."

	AddProperty bag, "OperatorBlock", "Boolean", False, _
		"Operator lock. Blocks the start until the operator releases it.", _
		"Bloqueio do operador. Impede a partida at� que o operador libere."
	...
	AddProperty bag, "GeneralBlock", "Boolean", False, _
		...
		"Intertravamento geral. Impede a partida e � selado por uma falha de passo at� que o Reset o apague."
	...
	AddProperty bag, "CommandReset", "InternalTag", Empty, _
		...
		"Comando de reset. Apaga as falhas seladas de passo e o bloqueio geral, para que uma sequ�ncia possa partir novamente."
	...
	AddProperty bag, "CommandStartTM", "InternalTag", Empty, _
		...
		"Comando de partida da transfer�ncia manual sem transformador impedido."
	...
	AddProperty bag, "CommandStartNM", "InternalTag", Empty, _
		...
		"Comando de partida da normaliza��o manual sem transformador impedido."
	...
	For trn = 1 To 4
		...
		AddProperty bag, "CommandStartTM" & (trn * 100), "InternalTag", Empty, _
			...
			"Comando de partida da transfer�ncia manual com o transformador " & (trn * 100) & " impedido."
		...
		AddProperty bag, "CommandStartNM" & (trn * 100), "InternalTag", Empty, _
			...
			"Comando de partida da normaliza��o manual com o transformador " & (trn * 100) & " impedido."
	...
	For i = 1 To 6
		...
		AddProperty bag, "StepExecutionFailed" & i, "Boolean", False, _
			...
			"Falha selada do passo " & i & ". Marcada quando o passo n�o executa e o automatismo entra em bloqueio geral, apagada pelo Reset."
	...
	' pair reading PARADO and EM OPERA��O rather than NORMAL and
	...
	SetAlarm bag, "AutomaticBlock", "BLOQUEIO AUTOM�TICO", PAIR_BLOCKED,      SEV_MEDIUM
	SetAlarm bag, "Preconditions",  "PRECONDI��ES",        PAIR_PRECONDITION, SEV_MEDIUM
...
Const PAIR_PRECONDITION = "ATENDIDAS|N�O ATENDIDAS|0"
...
Sub xatm_Breaker_OnStartRunning()
	...
	AddProperty bag, "Id", "Integer", Empty, _
		...
		"Identificador num�rico �nico usado pelo automatismo para localizar este disjuntor."
	...
	AddProperty bag, "PositionOpen", "IOTag", Empty, _
		...
		"Entrada de posi��o aberto do rel� 1. Palavra de duplo ponto, ou contato 52b quando UseDoublePoints for False."
	...
	AddProperty bag, "PositionClosed", "IOTag", Empty, _
		...
		"Entrada de posi��o fechado do rel� 1. Palavra de duplo ponto, ou contato 52a quando UseDoublePoints for False."
	...
	AddProperty bag, "PositionOpenAlt", "IOTag", Empty, _
		...
		"Entrada de posi��o aberto do rel� 2. Deixe vazio quando n�o houver rel� redundante."
	...
	AddProperty bag, "PositionClosedAlt", "IOTag", Empty, _
		...
		"Entrada de posi��o fechado do rel� 2. Deixe vazio quando n�o houver rel� redundante."
	...
	AddProperty bag, "UseDoublePoints", "Boolean", True, _
		...
		"True - a posi��o vem de uma palavra de duplo ponto. False - a posi��o vem do par de contatos 52a/52b."
	...
	AddProperty bag, "NormalState", "EdbSwitchState", 1, _
		...
		"Estado normal do equipamento. Refer�ncia para a normaliza��o e para o Modo Simula��o."
	...
	AddProperty bag, "CommandSBOClose", "IOTag", Empty, _
		...
		"Tag de sele��o do comando de fechamento no rel� 1. Opcional - o Select-Before-Operate s� ocorre quando preenchido."

	AddProperty bag, "CommandCloseAlt", "IOTag", Empty, _
		"Close output of relay 2. Used when relay 1 is unavailable.", _
		"Sa�da de fechamento do rel� 2. Usada quando o rel� 1 est� indispon�vel."
	...
	AddProperty bag, "Defective", "Boolean", False, _
		...
		"Equipamento com defeito e que n�o deve ser operado. Vinculada a uma express�o - fora de remoto, mola descarregada, o que o painel indicar."
	...
	AddProperty bag, "Position", "Integer", 0, _
		...
		"Posi��o como o automatismo a l�: 1 aberto, 2 fechado, 0 indefinido. Sempre estes tr�s, quaisquer que sejam os valores brutos do protocolo - os brutos s�o configurados acima e traduzidos para esta."
	...
	AddProperty bag, "CommandOpenFailed", "Boolean", False, _
		...
		"Falha selada de um comando de abertura enviado pelo automatismo. Marcada quando o disjuntor n�o atinge a posi��o aberta dentro de CommandTimeout, apagada pelo Reset."
	...
	AddProperty bag, "CommandCloseFailed", "Boolean", False, _
		...
		"Falha selada de um comando de fechamento enviado pelo automatismo. Marcada quando o disjuntor n�o atinge a posi��o fechada dentro de CommandTimeout, apagada pelo Reset."
...
Sub xatm_Disconnector_OnStartRunning()
	...
	AddProperty bag, "Motorized", "Boolean", True, _
		...
		"True quando a seccionadora tem comando motorizado que o automatismo pode acionar. False para manobra manual, que � apenas lida e nunca comandada."
...
Sub xatm_Transformer_OnStartRunning()
	...
	AddProperty bag, "UndervoltageDelay", "Integer", 25, _
		...
		"Tempo em segundos que a condi��o de subtens�o (27) deve permanecer antes que o automatismo atue."
...
Const NAME_HELP_PT = "Nome pelo qual este objeto � conhecido no projeto."
